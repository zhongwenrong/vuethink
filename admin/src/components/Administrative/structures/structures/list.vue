<template>
	<div>
		<div class="m-b-20">
			<router-link class="btn-link-large add-btn" to="add" style="height:36px;">
    ...
    stripe
      ...
      prop="status"
        ...
        <template scope="scope">
  				<div>
  					<span>
  						<router-link :to="{ name: 'structuresEdit', params: { id: scope.row.id }}" class="btnset btn-link edit-btn">
  						编辑
  						</router-link>
  					</span>
  					<span>
