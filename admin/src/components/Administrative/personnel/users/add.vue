<template>
	<div class="m-l-50 m-t-30 w-500">
		<el-form ref="form" :model="form" :rules="rules" label-width="130px">
			<el-form-item label="入驻企业名称" prop="company_name">
				<el-input v-model.trim="form.company_name" class="h-40 w-200" :maxlength="12"></el-input>
			</el-form-item>
  ...
  export default {
    data() {
      ...
      return {
        ...
        rules: {
          company_name: [
            { required: true, message: '请输入入驻企业名称' }
          ],
          realname: [
