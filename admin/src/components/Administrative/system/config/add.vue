<template>
	<div class="m-l-50 m-t-30 w-500">
      ...
      <el-form-item label="流量上限" prop="USER_LIMIT">
        <el-input v-model.number="form.USER_LIMIT" class="h-40 w-200"></el-input>
      </el-form-item>
			<el-form-item>
    ...
    created() {
      ...
      this.apiPost('admin/base/getConfigs').then((res) => {
        this.handelResponse(res, (data) => {
          ...
          this.form.USER_LIMIT = data.USER_LIMIT
          if (data.SYSTEM_LOGO) {
